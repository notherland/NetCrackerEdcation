...
public class Person {
    ...
    public Person (String fullname){
        ...
        switch (strs.length) {
            case 0: throw new NoSuchElementException("No input");
            case 1: throw new NoSuchElementException("No name and patronymic");
            case 2: throw new NoSuchElementException("No patronymic");
        }
